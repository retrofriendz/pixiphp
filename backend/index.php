...
$url = "https://lostastronaut.com/pixigame/".$_POST['ENDPOINT']; // the index.php is optional if _htaccess is used
// since we don't necessarily have a cert when testing, we'll change it
$url = "http://lostastronaut.com/pixigame/".$_POST['ENDPOINT'];
...
<FORM method=POST>
 Endpoint: <INPUT name="ENDPOINT" type="TEXT" value="<?php echo $_POST['ENDPOINT']; ?>"><BR>
